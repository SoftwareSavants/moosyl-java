...
public class SubscriptionCreateTrialEnd extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(SubscriptionCreateTrialEnd.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SubscriptionCreateTrialEnd.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SubscriptionCreateTrialEnd' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<SubscriptionCreateTrialEnd>() {
                @Override
                public void write(JsonWriter out, SubscriptionCreateTrialEnd value) throws IOException {
                    ...
                    throw new IOException("Failed to serialize as the type doesn't match anyOf schemas: BigDecimal, LocalDate, OffsetDateTime");
                }

                @Override
                public SubscriptionCreateTrialEnd read(JsonReader in) throws IOException {
                    ...
                    try {
                        ...
                        SubscriptionCreateTrialEnd ret = new SubscriptionCreateTrialEnd();
                    ...
                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for SubscriptionCreateTrialEnd: no class matches result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public SubscriptionCreateTrialEnd() {
        super("anyOf", Boolean.FALSE);
    }

    public SubscriptionCreateTrialEnd(Object o) {
        super("anyOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return SubscriptionCreateTrialEnd.schemas;
    }

    /**
     * Set the instance that matches the anyOf child schema, check
     * the instance parameter is valid against the anyOf child schemas:
     * BigDecimal, LocalDate, OffsetDateTime
     *
    ...
    public void setActualInstance(Object instance) {
        ...
        throw new RuntimeException("Invalid instance type. Must be BigDecimal, LocalDate, OffsetDateTime");
    }
     ...
     * BigDecimal, LocalDate, OffsetDateTime
     *
     * @return The actual instance (BigDecimal, LocalDate, OffsetDateTime)
     */
    @SuppressWarnings("unchecked")
    @Override
     ...
     * @throws IOException if the JSON Element is invalid with respect to SubscriptionCreateTrialEnd
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for SubscriptionCreateTrialEnd with anyOf schemas: BigDecimal, LocalDate, OffsetDateTime. no class match the result, expected at least 1. Detailed failure message for anyOf schemas: %s. JSON: %s", errorMessages, jsonElement.toString()));
    }

    /**
     * Create an instance of SubscriptionCreateTrialEnd given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of SubscriptionCreateTrialEnd
     * @throws IOException if the JSON string is invalid with respect to SubscriptionCreateTrialEnd
     */
    public static SubscriptionCreateTrialEnd fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, SubscriptionCreateTrialEnd.class);
    }

    /**
     * Convert an instance of SubscriptionCreateTrialEnd to an JSON string
     *
     * @return JSON string
     */
